...
const config = {
  title: 'Tom Patterson',
  tagline: 'Senior Technical Writer | Documentation Solutions and Content | API Specialist',
  ...
  organizationName: 'twpatters', // Usually your GitHub org/user name.
...
*/
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/twpatters-social-card.webp',
      colorMode: {
